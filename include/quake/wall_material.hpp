...
class WallUniaxial {
public:
    enum class Kind { Elastic, SteelBilinear, Concrete01 };
    ...
    double initial_tangent() const { return E_; }
    int state_size() const { return 6; }
...
public:
    ...
    int state_size() const { return static_cast<int>(layers_.size())*6; }
