...
Pinching4CyclicParameters shear(){Pinching4CyclicParameters p{};p.envelope.positive={{{.00010787,171.319},{.288,285.531},{.72,299.808},{1.2,138.0068}}};p.envelope.negative={{{-.00010787,-171.319},{-.288,-285.531},{-.72,-299.808},{-1.2,-138.0068}}};p.r_disp_positive=p.r_disp_negative=.6;p.r_force_positive=p.r_force_negative=.99;p.u_force_positive=p.u_force_negative=.4;p.gamma_d={.1,0,0,0};p.gamma_d_limit=2;p.gamma_e=10000;p.damage_mode=Pinching4DamageMode::Energy;p.admitted_reversal_count=6;return p;}
